                    ...
                    <div class="col-12">
                        <div class="card card-chart">
                            <div class="card-header ">
                                ...
                                <button class="btn btn-primary d-block" type="button" data-toggle="collapse" data-target="#formlevel" aria-expanded="false" aria-controls="formlevel">
                                    Tambah Level
                                </button>
                                <div class="collapse" id="formlevel">
                                    <div class="bg-light-purple p-3">
                                        <form>
                                            <div class="row">
                                                <div class="col">
                                                    <label for="">ID Level</label>
                                                    <input type="text" class="form-control bg-light-purple" placeholder="AUTO GENERATED" readonly>
                                                </div>
                                                <div class="col">
                                                    <label for="">Nama Level</label>
                                                    <input type="text" class="form-control border border-primary" placeholder="Nama Level">
                                                </div>
                                                <div class="col pt-3">
                                                    <button type="reset" class="btn btn-primary" data-toggle="collapse" data-target="#formlevel" aria-expanded="false" aria-controls="formlevel">
                                                        Batal
                                                    </button>
                                ...
                                <button class="btn btn-primary d-block" type="button" data-toggle="collapse" data-target="#collapseExample" aria-expanded="false" aria-controls="collapseExample">
                                    Tambah User
                                </button>
                                    ...
                                    <div class="bg-light-purple">
                                        <form>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select multiple class="form-control border border-primary" id="status">
                                                    <option>1</option>
                                                    <option>2</option>
                                                    <option>3</option>
                                                    <option>4</option>
